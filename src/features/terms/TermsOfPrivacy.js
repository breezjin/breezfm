  ...
  return (
    <StyledVideos>
      <div className='content'>
        <p>
          BREEZ Communications LLC('breez.fm', 이하 'BREEZ')는 「개인정보
          보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한
          고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이
          개인정보 처리방침을 수립·공개합니다.
        </p>
        <p>이 개인정보처리방침은 202년 1월 1일 부터 적용됩니다.</p>
        <br />
        <p className='jo'>
          <strong>제1조(개인정보의 처리 목적)</strong>
        </p>
        <p className='hang'>
          BREEZ는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
        ...
        <p className='hang'>
          ① BREEZ는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
        ...
        <p className='hang'>
          ② 개인정보 저장방식은 다음과 같습니다.
          <p className='ls2'>
            1. 회원가입을 통해 수집한 가명과 이메일 정보를 DB에 저장합니다.
          </p>
          <p className='ls2'>2. 작성한 FEED 정보를 DB에 저장 합니다.</p>
          <p className='ls2'>
            3. DB에 저장된 개인정보는 외부 서비스와 공유되지 않고, BREEZ
            서비스에만 한정해서 활용 합니다.
          </p>
        </p>
        <p className='hang'>
          ...
          <p className='ls2'>
            1. 회원가입을 통해 수집한 개인정보는 1년 단위로 갱신 합니다.
          </p>
          <p className='ls2'>
            2. 회원탈퇴를 진행한 개인정보는 1년 보관 후 폐기 합니다.
          </p>
          <p className='ls2'>
            3. 민원사무 처리와 관련한 개인정보는 수집.이용에 관한 동의일로부터
        ...
        <p className='hang'>
          ① 정보주체는 BREEZ에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
          요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p className='hang'>
          ② 제1항에 따른 권리 행사는 BREEZ에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 BREEZ는 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p className='hang'>
        ...
        <p className='hang'>
          ⑥ BREEZ는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
          처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
          대리인인지를 확인합니다.
        </p>
        <br />
        <p className='jo'>제4조(처리하는 개인정보의 항목 작성)</p>
        <p>
          ① BREEZ는 다음의 개인정보 항목을 처리하고 있습니다.
          <p>
            1. 홈페이지 회원가입 및 관리
            <ul>
              <li>
        ...
        <br />
        <p className='jo'>제5조(개인정보의 파기)</p>
        <p>
          ① BREEZ는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
        ...
        <p>
          ...
          <ol>
            <li>
              파기절차 : BREEZ는 파기 사유가 발생한 개인정보를 선정하고, BREEZ의
        ...
        <br />
        <p className='jo'>제6조(개인정보의 안전성 확보 조치)</p>
        <p>
          BREEZ는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
          있습니다.
          <p>
            1. 정기적인 자체 감사 실시
            <p>
          ...
          <p>
            4. 해킹 등에 대비한 기술적 대책
            <p>
              BREEZ는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을
        ...
        <p>
          ① BREEZ는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를
        ...
        <br />
        <p className='jo'>제8조 (개인정보 보호책임자)</p>
        <p>
          ① BREEZ는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
        ...
        <p>
          ② 정보주체께서는 BREEZ의 서비스(또는 사업)을 이용하시면서 발생한 모든
          개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
          보호책임자 및 담당부서로 문의하실 수 있습니다. BREEZ는 정보주체의
          문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
        </p>
        <br />
        <p className='jo'>제9조(가명정보의 처리)</p>
        <p>
          BREEZ는 다음과 같은 목적으로 가명정보를 처리하고 있습니다.
          <p>1. 가명정보의 처리 목적 - FEED 작성자 표기</p>
          <p>2. 가명정보의 처리 및 보유기간 - 영구</p>
          <p>3. 가명처리하는 개인정보의 항목 - 모든 회원정보</p>
          <p>
            4. 법 제28조의4(가명정보에 대한 안전조치 의무 등)에 따른 가명정보의
            안전성 확보조치에 관한 사항 - 이용자는 난수화된 아이드를 활용해서
            구분 합니다.
          </p>
        </p>
        <br />
        <p className='jo'>제10조(개인정보 열람청구)</p>
        <p>
          정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를
          아래의 부서에 할 수 있습니다. BREEZ는 정보주체의 개인정보 열람청구가
          신속하게 처리되도록 노력하겠습니다.
        </p>
        <br />
        <p className='jo'>제11조(권익침해 구제방법)</p>
        <p>
        ...
        <br />
        <p className='jo'>제12조(개인정보 처리방침 변경)</p>
        <p>① 이 개인정보처리방침은 2022년 1월 1부터 적용됩니다.</p>
        <p>
          ② 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.
          <p>최초 개인정보 처리방침으로 이전 자료 없음.</p>
        </p>
      </div>
    </StyledVideos>
  );
