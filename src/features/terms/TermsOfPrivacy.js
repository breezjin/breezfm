        ...
        <div>
          ...
          <ol>
            ...
            <p className='ls2'>
              5. 위치정보 활용
              <br />
              사용자 브라우저의 위치정보를 바탕으로 최적화된 음악 리스트를 구성
              합니다. 사용자의 위치정보는 YouTube API Search Query에 활용
              됩니다. 사용자가 원하지 않는 경우 브라우저의 위치공유 기능을 끌 수
              있습니다.
            </p>
            ...
            <p className='ls2'>
              6. YouTube API 활용
              <br />
              5번 사용자 브라우저의 위치정보를 바탕으로 YouTube API를 활용해
              플레이 리스트를 세팅 합니다. 플레이 리스트는 서비스의 전역상태
              관리 저장소에 저장되어 활용 되며, 서비스 접근을 갱신하는 경우
